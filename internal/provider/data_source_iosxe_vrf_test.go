...
func TestAccDataSourceIosxeVRF(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_vrf.test", "vnids.0.vnid", "10001"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_vrf.test", "vnids.0.evpn_instance_vnis.0.vni", "20000"))
