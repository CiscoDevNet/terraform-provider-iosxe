...
func TestAccIosxeInterfacePortChannelSubinterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_port_channel_subinterface.test", "ip_nat_inside", "true"))
