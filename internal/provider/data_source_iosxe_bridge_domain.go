...
func (d *BridgeDomainDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Bridge Domain configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"bridge_domain_id": schema.Int64Attribute{
				MarkdownDescription: "<1..16000>;;bridge-domain ID",
				Required:            true,
			},
...
func (d *BridgeDomainDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = BridgeDomainData{Device: config.Device}
		} else {
			if err != nil {
