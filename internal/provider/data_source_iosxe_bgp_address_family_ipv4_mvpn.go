...
var (
	_ datasource.DataSource              = &BGPAddressFamilyIPv4MVPNDataSource{}
	_ datasource.DataSourceWithConfigure = &BGPAddressFamilyIPv4MVPNDataSource{}
)

func NewBGPAddressFamilyIPv4MVPNDataSource() datasource.DataSource {
	return &BGPAddressFamilyIPv4MVPNDataSource{}
}
...
func (d *BGPAddressFamilyIPv4MVPNDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the BGP Address Family IPv4 MVPN configuration.",
...
func (d *BGPAddressFamilyIPv4MVPNDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config BGPAddressFamilyIPv4MVPNData
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = BGPAddressFamilyIPv4MVPNData{Device: config.Device}
		} else {
			if err != nil {
