...
func TestAccDataSourceIosxeVTP(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_vtp.test", "interface_interface_name", "Gi1/0/1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_vtp.test", "password_password", "test123"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_vtp.test", "password_hidden", "true"))
