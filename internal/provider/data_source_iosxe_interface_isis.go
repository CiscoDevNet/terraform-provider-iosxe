...
var (
	_ datasource.DataSource              = &InterfaceISISDataSource{}
	_ datasource.DataSourceWithConfigure = &InterfaceISISDataSource{}
)

func NewInterfaceISISDataSource() datasource.DataSource {
	return &InterfaceISISDataSource{}
}
...
func (d *InterfaceISISDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Interface ISIS configuration.",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"level": schema.StringAttribute{
							MarkdownDescription: "IS-IS level (level-1 or level-2)",
							Computed:            true,
						},
						"value": schema.Int64Attribute{
							MarkdownDescription: "Metric value (1-16777214)",
							Computed:            true,
						},
					},
				},
...
func (d *InterfaceISISDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = InterfaceISISData{Device: config.Device}
		} else {
			if err != nil {
