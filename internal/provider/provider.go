...
func (p *IosxeProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	helpers.SetDiscardOnConnect(c, discardOnConnect)
	...
	for _, device := range config.Devices {
		...
		helpers.SetDiscardOnConnect(devClient, discardOnConnect)
...
func (p *IosxeProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewKeyChainResource,
		NewL2VFIResource,
		NewLargeCommunityListExpandedResource,
		NewLicenseResource,
		NewLineResource,
		NewLLDPResource,
		NewLoggingResource,
...
func (p *IosxeProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewL2VFIDataSource,
		NewLargeCommunityListExpandedDataSource,
