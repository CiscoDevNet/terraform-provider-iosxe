...
func TestAccIosxeAAAAccounting(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_aaa_accounting.test", "identities.0.start_stop_broadcast", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_aaa_accounting.test", "identities.0.start_stop_group_broadcast", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_aaa_accounting.test", "identities.0.start_stop_group_logger", "true"))
