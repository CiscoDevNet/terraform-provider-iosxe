...
var (
	_ datasource.DataSource              = &CommunityListStandardDataSource{}
	_ datasource.DataSourceWithConfigure = &CommunityListStandardDataSource{}
)

func NewCommunityListStandardDataSource() datasource.DataSource {
	return &CommunityListStandardDataSource{}
}
...
func (d *CommunityListStandardDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Community List Standard configuration.",
...
func (d *CommunityListStandardDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config CommunityListStandardData
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = CommunityListStandardData{Device: config.Device}
		} else {
			if err != nil {
