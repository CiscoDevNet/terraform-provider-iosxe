...
func TestAccDataSourceIosxeBFDTemplateMultiHop(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_bfd_template_multi_hop.test", "interval_multihop_v2_units_mill_unit_min_tx", "4500"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_bfd_template_multi_hop.test", "interval_multihop_v2_units_mill_unit_min_rx", "5500"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_bfd_template_multi_hop.test", "interval_multihop_v2_mill_unit_multiplier", "40"))
...
func testAccDataSourceIosxeBFDTemplateMultiHopConfig() string {
	...
	config += `	name = "T11"` + "\n"
	config += `	echo = true` + "\n"
	config += `	interval_multihop_v2_units_mill_unit_min_tx = 4500` + "\n"
	config += `	interval_multihop_v2_units_mill_unit_min_rx = 5500` + "\n"
	config += `	interval_multihop_v2_mill_unit_multiplier = 40` + "\n"
