...
func TestAccIosxeInterfaceOSPF(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ospf.test", "message_digest_key.0.id", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ospf.test", "message_digest_key.0.md5_auth_key", "anyname"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ospf.test", "message_digest_key.0.md5_auth_type", "0"))
