...
func TestAccIosxeInterfaceLoopback(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_loopback.test", "ip_verify_unicast_source_reachable_via", "rx"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_loopback.test", "ip_verify_unicast_source_allow_self_ping", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_loopback.test", "ip_verify_unicast_source_allow_default", "true"))
