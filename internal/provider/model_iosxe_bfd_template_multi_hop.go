...
type BFDTemplateMultiHop struct {
	...
	IntervalMultihopV2UnitsBoth          types.Int64  `tfsdk:"interval_multihop_v2_units_both"`
	IntervalMultihopV2UnitsMillUnitMinTx types.Int64  `tfsdk:"interval_multihop_v2_units_mill_unit_min_tx"`
	IntervalMultihopV2UnitsMillUnitMinRx types.Int64  `tfsdk:"interval_multihop_v2_units_mill_unit_min_rx"`
	IntervalMultihopV2MillUnitMultiplier types.Int64  `tfsdk:"interval_multihop_v2_mill_unit_multiplier"`
...
func (data BFDTemplateMultiHop) toBody(ctx context.Context) string {
	...
	if !data.IntervalMultihopV2UnitsBoth.IsNull() && !data.IntervalMultihopV2UnitsBoth.IsUnknown() {
		body, _ = sjson.Set(body, helpers.LastElement(data.getPath())+"."+"interval-multihop-v2.mill-unit.both", strconv.FormatInt(data.IntervalMultihopV2UnitsBoth.ValueInt64(), 10))
	}
	if !data.IntervalMultihopV2UnitsMillUnitMinTx.IsNull() && !data.IntervalMultihopV2UnitsMillUnitMinTx.IsUnknown() {
		body, _ = sjson.Set(body, helpers.LastElement(data.getPath())+"."+"interval-multihop-v2.mill-unit.min-tx", strconv.FormatInt(data.IntervalMultihopV2UnitsMillUnitMinTx.ValueInt64(), 10))
	}
	if !data.IntervalMultihopV2UnitsMillUnitMinRx.IsNull() && !data.IntervalMultihopV2UnitsMillUnitMinRx.IsUnknown() {
		body, _ = sjson.Set(body, helpers.LastElement(data.getPath())+"."+"interval-multihop-v2.mill-unit.min-rx", strconv.FormatInt(data.IntervalMultihopV2UnitsMillUnitMinRx.ValueInt64(), 10))
	}
	if !data.IntervalMultihopV2MillUnitMultiplier.IsNull() && !data.IntervalMultihopV2MillUnitMultiplier.IsUnknown() {
		body, _ = sjson.Set(body, helpers.LastElement(data.getPath())+"."+"interval-multihop-v2.mill-unit.multiplier", strconv.FormatInt(data.IntervalMultihopV2MillUnitMultiplier.ValueInt64(), 10))
	}
...
func (data *BFDTemplateMultiHop) updateFromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "interval-multihop-v2.mill-unit.both"); value.Exists() && !data.IntervalMultihopV2UnitsBoth.IsNull() {
		data.IntervalMultihopV2UnitsBoth = types.Int64Value(value.Int())
	} else {
		data.IntervalMultihopV2UnitsBoth = types.Int64Null()
	}
	if value := res.Get(prefix + "interval-multihop-v2.mill-unit.min-tx"); value.Exists() && !data.IntervalMultihopV2UnitsMillUnitMinTx.IsNull() {
		data.IntervalMultihopV2UnitsMillUnitMinTx = types.Int64Value(value.Int())
	} else {
		data.IntervalMultihopV2UnitsMillUnitMinTx = types.Int64Null()
	}
	if value := res.Get(prefix + "interval-multihop-v2.mill-unit.min-rx"); value.Exists() && !data.IntervalMultihopV2UnitsMillUnitMinRx.IsNull() {
		data.IntervalMultihopV2UnitsMillUnitMinRx = types.Int64Value(value.Int())
	} else {
		data.IntervalMultihopV2UnitsMillUnitMinRx = types.Int64Null()
	}
	if value := res.Get(prefix + "interval-multihop-v2.mill-unit.multiplier"); value.Exists() && !data.IntervalMultihopV2MillUnitMultiplier.IsNull() {
		data.IntervalMultihopV2MillUnitMultiplier = types.Int64Value(value.Int())
	} else {
		data.IntervalMultihopV2MillUnitMultiplier = types.Int64Null()
	}
