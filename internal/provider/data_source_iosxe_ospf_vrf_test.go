...
func TestAccDataSourceIosxeOSPFVRF(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ospf_vrf.test", "area.0.area_id", "5"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ospf_vrf.test", "area.0.authentication_message_digest", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ospf_vrf.test", "area.0.nssa", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ospf_vrf.test", "area.0.nssa_nssa_options_no_summary", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ospf_vrf.test", "area.0.nssa_nssa_options_no_redistribution", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ospf_vrf.test", "passive_interface_passive_interface_choice_default_default", "true"))
