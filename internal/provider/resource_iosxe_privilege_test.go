...
func TestAccIosxePrivilege(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:            "iosxe_privilege.test",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateIdFunc:       iosxePrivilegeImportStateIdFunc("iosxe_privilege.test"),
...
func iosxePrivilegeImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
