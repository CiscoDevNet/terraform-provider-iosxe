...
type BGPNeighbor struct {
	...
	FallOverBfdMultiHops                types.Bool   `tfsdk:"fall_over_bfd_multi_hops"`
...
func (data BGPNeighbor) toBody(ctx context.Context) string {
	...
	if !data.FallOverBfdMultiHops.IsNull() && !data.FallOverBfdMultiHops.IsUnknown() {
		if data.FallOverBfdMultiHops.ValueBool() {
...
func (data *BGPNeighbor) updateFromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "fall-over.bfd.multi-hop"); !data.FallOverBfdMultiHops.IsNull() {
		if value.Exists() {
			data.FallOverBfdMultiHops = types.BoolValue(true)
		} else {
			data.FallOverBfdMultiHops = types.BoolValue(false)
		}
	} else {
		data.FallOverBfdMultiHops = types.BoolNull()
	}
...
func (data *BGPNeighbor) getEmptyLeafsDelete(ctx context.Context) []string {
	...
	if !data.FallOverBfdMultiHops.IsNull() && !data.FallOverBfdMultiHops.ValueBool() {
...
func (data *BGPNeighbor) getDeletePaths(ctx context.Context) []string {
	...
	if !data.FallOverBfdMultiHops.IsNull() {
