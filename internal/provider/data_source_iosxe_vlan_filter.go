...
var (
	_ datasource.DataSource              = &VLANFilterDataSource{}
	_ datasource.DataSourceWithConfigure = &VLANFilterDataSource{}
)

func NewVLANFilterDataSource() datasource.DataSource {
	return &VLANFilterDataSource{}
}
...
func (d *VLANFilterDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the VLAN Filter configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"vlan_lists": schema.ListAttribute{
				MarkdownDescription: "VLANs to apply filter to",
...
func (d *VLANFilterDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = VLANFilterData{Device: config.Device}
		} else {
			if err != nil {
