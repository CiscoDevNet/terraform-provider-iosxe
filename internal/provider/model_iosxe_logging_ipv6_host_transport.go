...
func (data *LoggingIPv6HostTransport) getIdsFromPath() {
	reString := strings.ReplaceAll("Cisco-IOS-XE-native:native/logging/host/ipv6/ipv6-host-transport-list=%s", "%s", "(.+)")
