...
func TestAccIosxeInterfacePortChannel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_port_channel.test", "ipv6_link_local_addresses.0.address", "fe80::9656:d028:8652:66b9"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_port_channel.test", "ipv6_addresses.0.prefix", "2004:DB8::/32"))
