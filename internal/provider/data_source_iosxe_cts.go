...
var (
	_ datasource.DataSource              = &CTSDataSource{}
	_ datasource.DataSourceWithConfigure = &CTSDataSource{}
)

func NewCTSDataSource() datasource.DataSource {
	return &CTSDataSource{}
}
...
func (d *CTSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the CTS configuration.",
