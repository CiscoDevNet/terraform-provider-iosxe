...
func TestAccDataSourceIosxeRadius(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_radius.test", "address_acct_port", "1812"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_radius.test", "automate_tester_type_of_testing_probe_on_config_probe_on_config", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_radius.test", "pac_key_key", "testtest1"))
