...
type VTP struct {
	...
	InterfaceInterfaceName types.String `tfsdk:"interface_interface_name"`
	InterfaceOnly          types.Bool   `tfsdk:"interface_only"`
	PasswordPassword       types.String `tfsdk:"password_password"`
...
func (data VTP) toBody(ctx context.Context) string {
	...
	if !data.InterfaceInterfaceName.IsNull() && !data.InterfaceInterfaceName.IsUnknown() {
		body, _ = sjson.Set(body, helpers.LastElement(data.getPath())+"."+"Cisco-IOS-XE-vtp:interface.interface-name", data.InterfaceInterfaceName.ValueString())
	}
	...
	if !data.PasswordPassword.IsNull() && !data.PasswordPassword.IsUnknown() {
		body, _ = sjson.Set(body, helpers.LastElement(data.getPath())+"."+"Cisco-IOS-XE-vtp:password.password", data.PasswordPassword.ValueString())
	}
...
func (data *VTP) updateFromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "Cisco-IOS-XE-vtp:interface.interface-name"); value.Exists() && !data.InterfaceInterfaceName.IsNull() {
		data.InterfaceInterfaceName = types.StringValue(value.String())
	} else {
		data.InterfaceInterfaceName = types.StringNull()
	}
	...
	if value := res.Get(prefix + "Cisco-IOS-XE-vtp:password.password"); value.Exists() && !data.PasswordPassword.IsNull() {
		data.PasswordPassword = types.StringValue(value.String())
	} else {
		data.PasswordPassword = types.StringNull()
	}
...
func (data *VTP) getDeletePaths(ctx context.Context) []string {
	...
	if !data.Version.IsNull() {
		deletePaths = append(deletePaths, fmt.Sprintf("%v/Cisco-IOS-XE-vtp:version", data.getPath()))
	}
	if !data.InterfaceInterfaceName.IsNull() {
	...
	if !data.PasswordPassword.IsNull() {
	...
	if !data.Domain.IsNull() {
		deletePaths = append(deletePaths, fmt.Sprintf("%v/Cisco-IOS-XE-vtp:domain", data.getPath()))
	}
