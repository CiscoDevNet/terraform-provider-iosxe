...
func TestAccIosxeCryptoIKEv2Policy(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_crypto_ikev2_policy.test", "name", "aws_vpg_1"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:   true,
				ImportStateId: "Cisco-IOS-XE-native:native/crypto/Cisco-IOS-XE-crypto:ikev2/policy=aws_vpg_1",
			},
		},
	})
}
