	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"policies": schema.ListNestedAttribute{
				MarkdownDescription: "Configure a policy for feature device-tracking",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"trusted_port": schema.BoolAttribute{
							MarkdownDescription: "setup trusted port",
							Computed:            true,
						},
						"device_role": schema.StringAttribute{
							MarkdownDescription: "The role of the device attached to the port",
							Computed:            true,
						},
