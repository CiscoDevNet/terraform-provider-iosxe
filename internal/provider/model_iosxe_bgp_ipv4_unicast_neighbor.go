...
func (data BGPIPv4UnicastNeighbor) getXPath() string {
	path := helpers.ConvertRestconfPathToXPath("Cisco-IOS-XE-native:native/router/Cisco-IOS-XE-bgp:bgp=%v/address-family/no-vrf/ipv4=unicast/ipv4-unicast/neighbor=%s")
...
func (data BGPIPv4UnicastNeighbor) toBodyXML(ctx context.Context) string {
	body := netconf.Body{}
	if !data.Ip.IsNull() && !data.Ip.IsUnknown() {
