...
var (
	_ datasource.DataSource              = &OSPFv3AddressFamilyIPv6VRFDataSource{}
	_ datasource.DataSourceWithConfigure = &OSPFv3AddressFamilyIPv6VRFDataSource{}
)

func NewOSPFv3AddressFamilyIPv6VRFDataSource() datasource.DataSource {
	return &OSPFv3AddressFamilyIPv6VRFDataSource{}
}

type OSPFv3AddressFamilyIPv6VRFDataSource struct {
	data *IosxeProviderData
}

func (d *OSPFv3AddressFamilyIPv6VRFDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ospfv3_address_family_ipv6_vrf"
}

func (d *OSPFv3AddressFamilyIPv6VRFDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the OSPFv3 Address Family IPv6 VRF configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"summary_prefix": schema.ListNestedAttribute{
				MarkdownDescription: "Configure IPv6 summary prefix",
				Computed:            true,
...
func (d *OSPFv3AddressFamilyIPv6VRFDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *OSPFv3AddressFamilyIPv6VRFDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config OSPFv3AddressFamilyIPv6VRFData
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = OSPFv3AddressFamilyIPv6VRFData{Device: config.Device}
		} else {
			if err != nil {
