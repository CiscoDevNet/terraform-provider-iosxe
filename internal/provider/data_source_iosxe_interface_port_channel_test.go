...
func TestAccDataSourceIosxeInterfacePortChannel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_port_channel.test", "template", "portchannel_template1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_port_channel.test", "enable", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_port_channel.test", "local_address", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_port_channel.test", "interval_interface_msecs", "750"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_port_channel.test", "interval_interface_min_rx", "750"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_port_channel.test", "interval_interface_multiplier", "3"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_port_channel.test", "echo", "true"))
