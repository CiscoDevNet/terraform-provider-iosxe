...
func TestAccIosxeSNMPServer(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_snmp_server.test", "users.0.v3_auth_password", "Cisco123"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_snmp_server.test", "users.0.v3_auth_priv_aes_algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_snmp_server.test", "users.0.v3_auth_priv_aes_password", "Cisco123"))
