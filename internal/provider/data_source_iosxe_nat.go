...
var (
	_ datasource.DataSource              = &NATDataSource{}
	_ datasource.DataSourceWithConfigure = &NATDataSource{}
)
...
func (d *NATDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the NAT configuration.",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"interfaces": schema.ListNestedAttribute{
							MarkdownDescription: "Specify interface for global address",
							Computed:            true,
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
...
func (d *NATDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = NATData{Device: config.Device}
		} else {
			if err != nil {
