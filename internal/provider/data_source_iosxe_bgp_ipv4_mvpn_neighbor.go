...
var (
	_ datasource.DataSource              = &BGPIPv4MVPNNeighborDataSource{}
	_ datasource.DataSourceWithConfigure = &BGPIPv4MVPNNeighborDataSource{}
)

func NewBGPIPv4MVPNNeighborDataSource() datasource.DataSource {
	return &BGPIPv4MVPNNeighborDataSource{}
}
...
func (d *BGPIPv4MVPNNeighborDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the BGP IPv4 MVPN Neighbor configuration.",
...
func (d *BGPIPv4MVPNNeighborDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config BGPIPv4MVPNNeighborData
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = BGPIPv4MVPNNeighborData{Device: config.Device}
		} else {
			if err != nil {
