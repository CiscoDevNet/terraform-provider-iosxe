...
func TestAccIosxeDot1x(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_dot1x.test", "dot1x_credentials.0.profile_name", "profile1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_dot1x.test", "dot1x_credentials.0.description", "credential_profile_name"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_dot1x.test", "dot1x_credentials.0.username", "username1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_dot1x.test", "dot1x_credentials.0.password_secret", "password123"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_dot1x.test", "dot1x_credentials.0.pki_trustpoint", "trustpoint1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_dot1x.test", "dot1x_credentials.0.anonymous_id", "1"))
