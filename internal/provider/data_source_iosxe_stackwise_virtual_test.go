...
func TestAccDataSourceIosxeStackwiseVirtual(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_stackwise_virtual.test", "dual_active_detection_pagp_trust_channel_group", "1"))
...
func testAccDataSourceIosxeStackwiseVirtualConfig() string {
