...
func TestAccIosxePolicyMapEvent(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_policy_map_event.test", "class_numbers.0.action_numbers.0.authenticate_using_aaa_config", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_policy_map_event.test", "class_numbers.0.action_numbers.0.authenticate_using_authc_list", "listname1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_policy_map_event.test", "class_numbers.0.action_numbers.0.authenticate_using_authz_list", "listname2"))
