...
var (
	_ datasource.DataSource              = &CommunityListExpandedDataSource{}
	_ datasource.DataSourceWithConfigure = &CommunityListExpandedDataSource{}
)

func NewCommunityListExpandedDataSource() datasource.DataSource {
	return &CommunityListExpandedDataSource{}
}
...
func (d *CommunityListExpandedDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Community List Expanded configuration.",
...
func (d *CommunityListExpandedDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config CommunityListExpandedData
	...
	if device.Protocol == "restconf" {
		...
		if res.StatusCode == 404 {
			config = CommunityListExpandedData{Device: config.Device}
		} else {
			if err != nil {
