...
func TestAccIosxeBFDTemplateMultiHop(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_bfd_template_multi_hop.test", "interval_multihop_v2_units_mill_unit_min_tx", "4500"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_bfd_template_multi_hop.test", "interval_multihop_v2_units_mill_unit_min_rx", "5500"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_bfd_template_multi_hop.test", "interval_multihop_v2_mill_unit_multiplier", "40"))
