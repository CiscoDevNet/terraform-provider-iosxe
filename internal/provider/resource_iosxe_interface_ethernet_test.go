...
func TestAccIosxeInterfaceEthernet(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ethernet.test", "hold_queue.0.direction", "in"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ethernet.test", "hold_queue.0.queue_length", "50"))
