...
func TestAccIosxeSystem(t *testing.T) {
	...
	if os.Getenv("C8000V") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxe_system.test", "authentication_mac_move_permit", "true"))
	}
	if os.Getenv("C8000V") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxe_system.test", "authentication_mac_move_deny_uncontrolled", "true"))
	}
