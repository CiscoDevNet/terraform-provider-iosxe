...
func (data *BGPL2VPNEVPNNeighbor) getIdsFromPath() {
	reString := strings.ReplaceAll("Cisco-IOS-XE-native:native/router/Cisco-IOS-XE-bgp:bgp=%v/address-family/no-vrf/l2vpn=evpn/l2vpn-evpn/neighbor=%s", "%s", "(.+)")
