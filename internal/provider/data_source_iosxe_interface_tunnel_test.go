...
func TestAccDataSourceIosxeInterfaceTunnel(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "unreachables", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ra_suppress_all", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ipv6_address_dhcp", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "ipv6_link_local_addresses.0.address", "fe80::9656:d028:8652:66b6"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_tunnel.test", "interval_interface_msecs", "50"))
