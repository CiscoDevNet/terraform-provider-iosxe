...
- `pre_shared_key_local_wo` (String) The write-only value of the attribute.
...
- `pre_shared_key_remote_wo` (String) The write-only value of the attribute.
- `pre_shared_key_remote_wo_version` (Number) The write-only version of the attribute.
- `pre_shared_key_wo` (String) The write-only value of the attribute.
