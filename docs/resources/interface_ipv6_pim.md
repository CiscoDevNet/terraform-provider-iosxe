...
page_title: "iosxe_interface_ipv6_pim Resource - terraform-provider-iosxe"
subcategory: "Multicast"
description: |-
  This resource can manage the Interface IPv6 PIM configuration.
---

# iosxe_interface_ipv6_pim (Resource)
...
```shell
terraform import iosxe_interface_ipv6_pim.example "<type>,<name>"
```
