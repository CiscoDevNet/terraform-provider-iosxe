...
page_title: "iosxe_eigrp Resource - terraform-provider-iosxe"
subcategory: "EIGRP"
description: |-
  This resource can manage the EIGRP configuration.
---

# iosxe_eigrp (Resource)
...
```shell
terraform import iosxe_eigrp.example "<name>"
```
