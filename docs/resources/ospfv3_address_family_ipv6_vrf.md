...
page_title: "iosxe_ospfv3_address_family_ipv6_vrf Resource - terraform-provider-iosxe"
subcategory: "OSPF"
description: |-
  This resource can manage the OSPFv3 Address Family IPv6 VRF configuration.
---

# iosxe_ospfv3_address_family_ipv6_vrf (Resource)
...
```shell
terraform import iosxe_ospfv3_address_family_ipv6_vrf.example "<process_id>,<vrf>"
```
