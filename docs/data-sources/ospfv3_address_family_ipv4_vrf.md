...
page_title: "iosxe_ospfv3_address_family_ipv4_vrf Data Source - terraform-provider-iosxe"
subcategory: "OSPF"
description: |-
  This data source can read the OSPFv3 Address Family IPv4 VRF configuration.
---

# iosxe_ospfv3_address_family_ipv4_vrf (Data Source)
...
```terraform
data "iosxe_ospfv3_address_family_ipv4_vrf" "example" {
  process_id = 2
  vrf        = "VRF1"
}
```
