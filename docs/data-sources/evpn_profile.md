...
page_title: "iosxe_evpn_profile Data Source - terraform-provider-iosxe"
subcategory: "EVPN"
description: |-
  This data source can read the EVPN Profile configuration.
---

# iosxe_evpn_profile (Data Source)
